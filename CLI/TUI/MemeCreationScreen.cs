...
namespace image_flip_bosch.CLI.TUI
{
  internal sealed class MemeCreationScreen : NanoScreen
  {
    ...
    public MemeCreationScreen(ConsoleWindowSystem ws, Meme meme, string? imagePath, bool customPositions, MemeCreationBox[]? previous = null, int? maxFontSize = null)
